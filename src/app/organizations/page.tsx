...
import { fetchOrganizations, setSelectedOrganization, deleteOrganization } from '@/store/slices/organizationsSlice';
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                ...
                <TableCell sx={{ fontWeight: 600 }}>Organizations Name</TableCell>
