...
import { fetchPolicies, setSelectedPolicy, deletePolicy } from '@/store/slices/policiesSlice';
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip
                        ...
                        color={getSeverityColor(policy.severity) as 'error' | 'warning' | 'success' | 'default'}
                        size="small"
                      />
                    </TableCell>
